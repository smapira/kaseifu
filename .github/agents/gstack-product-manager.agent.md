---
name: gstack-product-manager
description: "Use when: Product Manager (gstack) — CEO/TechLead pipeline, BDD planning and orchestrating gstack sub-agents (gstack @0d1bd56 MIT)"
user-invocable: true
tools:
  vscode: true
  execute: true
...
# Source: garrytan/gstack@0d1bd56 MIT — ported to OpenCode (English original, not translated)
# Original: office-hours/SKILL.md.tmpl
# Template reference: .github/agents/*.agent.md is used only as file-structure template (frontmatter), body is gstack original English verbatim
