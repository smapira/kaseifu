---
name: gstack-implementer
description: "Use when: Implementer (gstack) — implement BDD tasks in gstack pipeline (gstack @0d1bd56 MIT)"
...
# Original: autoplan/SKILL.md.tmpl
