...
description: "Use when: Architect (gstack) — /plan-eng-review architect track, validate layers, dependencies, reuse (gstack @0d1bd56 MIT)"
...
# Original: plan-eng-review/SKILL.md.tmpl
